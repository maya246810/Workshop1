...
```{r setup-tibble}
team_data <- tibble(
  name = c("Ella", "member 1", "member 2", 
           "member 3", "member 4"),
  github_username = c("ellalawrence1", "username 1", "username 2", 
                      "username 3", "username 4"), 
  colour = c("green", "colour 1", "colour 2", 
             "colour 3", "colour 4"),
  hobby = c("football", "hobby 1", "hobby 2", 
            "hobby 3", "hobby 4"),
  favourite_number = c(3, NA, NA, NA, NA)
  )
